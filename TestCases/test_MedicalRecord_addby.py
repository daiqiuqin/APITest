#-*-coding:utf-8 -*-
#@Time :2021/3/19 10:31
#@Author :daiqiuqin
#@File  :test_MedicalRecord_addby.py
...
@ddt
class test_MedicalRecord_addby(unittest.TestCase):
    @classmethod
    ...
    @data(*alldatas)
    def test_addMedicalRecord_by(self,data):
        # 判断是否跳过用例
        ...
        try:
            ...
            try:
                Wexcel(output_file, readSheet, self.row, id, title, method, request_url, request_body, expected,
                       ...
                       testResult)
                # 写入的行数加1
                test_MedicalRecord_addby.row += 1
            except IOError as e:
                print(e)
