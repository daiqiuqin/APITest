#-*-coding:utf-8 -*-
#@Time :2021/3/22 13:54
#@Author :daiqiuqin
#@File  :test_MedicalRecord_adddk.py
...
@ddt
class test_MedicalRecord_adddk(unittest.TestCase):
    @classmethod
    ...
    @data(*alldatas)
    def test_addMedicalRecord_dk(self,data):
        # 判断是否跳过用例
        ...
        try:
            ...
            try:
                Wexcel(output_file, readSheet, self.row, id, title, method, request_url, request_body, expected,
                       ...
                       testResult)
                # 写入的行数加1
                test_MedicalRecord_adddk.row += 1
            except IOError as e:
                print(e)
