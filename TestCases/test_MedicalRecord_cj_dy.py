#-*-coding:utf-8 -*-
#@Time :2021/4/16 14:02
#@Author :daiqiuqin
#@File  :test_MedicalRecord_cj_dy.py
...
@ddt
class test_MedicalRecord_cj_dy(unittest.TestCase):
    @classmethod
    ...
    @data(*alldatas)
    def test_MedicalRecord_cj_dy(self,data):
        # 判断是否跳过用例
        ...
        try:
            ...
            try:
                Wexcel(output_file, readSheet, self.row, id, title, method, request_url, request_body, expected,
                       ...
                       testResult)
                # 写入的行数加1
                test_MedicalRecord_cj_dy.row += 1
            except IOError as e:
                print(e)
