...
#@Time :2021/4/6 18:06
#@Author :daiqiuqin
#@File  :test_MedicalRecord_config.py
...
@ddt
class test_MedicalRecord_config(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        #执行testCase前先清除环境变量
        clear_EnvData_attrs()
        log.info("test_MedicalRecord_config测试套件开始执行,共有{}条用例".format(maxRow))

    @classmethod
    def tearDownClass(cls) -> None:
        log.info("test_MedicalRecord_config测试套件执行完毕")
    ...
    # 修改
    @data(alldatas[0])
    def test_MedicalRecord_config_01(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
        ...
        try:
            ...
            try:
                Wexcel(output_file, readSheet, self.row, id, title, method, request_url, request_body, expected,
                       ...
                       testResult)
                # 写入的行数加1
                test_MedicalRecord_config.row += 1
            except IOError as e:
                print(e)

    # 验证
    @data(alldatas[1])
    def test_MedicalRecord_config_02(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    # 修改
    @data(alldatas[2])
    def test_MedicalRecord_config_03(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    #验证
    @data(alldatas[3])
    def test_MedicalRecord_config_04(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
        ...
        if extract_data:
            # 提取json返回数据存入全局变量
            parameterValue ='\"parameterValueList\":' + str(jsonpath.jsonpath(response_json, extract_data)[0])
            setattr(EnvData, "parameterValue", parameterValue)
    ...
    # 修改
    @data(alldatas[4])
    def test_MedicalRecord_config_05(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    #验证
    @data(alldatas[5])
    def test_MedicalRecord_config_06(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
        ...
        if extract_data:
            # 提取json返回数据存入全局变量
            parameterValue = '\"parameterValue\":\"' + jsonpath.jsonpath(response_json, extract_data)[0]+'\"'
            setattr(EnvData, "parameterValue", parameterValue)
    ...
    # 修改
    @data(alldatas[6])
    def test_MedicalRecord_config_07(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    # 验证
    @data(alldatas[7])
    def test_MedicalRecord_config_08(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    #修改
    @data(alldatas[8])
    def test_MedicalRecord_config_09(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    # 验证
    @data(alldatas[9])
    def test_MedicalRecord_config_10(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    # 修改
    @data(alldatas[10])
    def test_MedicalRecord_config_11(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
    ...
    #验证
    @data(alldatas[11])
    def test_MedicalRecord_config_12(self,data):
        #####前置处理#####
        # 读取token
        # token = self.token
