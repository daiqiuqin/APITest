...
#@Author :daiqiuqin
#@File  :test_MedicalRecord_pass.py
...
@ddt
class test_MedicalRecord_pass(unittest.TestCase):
    @classmethod
    ...
    @data(*alldatas)
    def test_MedicalRecord_pass(self,data):
        # 判断是否跳过用例
