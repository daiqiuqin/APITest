#-*-coding:utf-8 -*-
#@Time :2021/5/27 20:11
#@Author :daiqiuqin
#@File  :test_telext_power.py
...
@ddt
class test_telext_power(unittest.TestCase):
    @classmethod
    ...
    @data(*alldatas)
    def test_telext_power(self,data):
        # 判断是否跳过用例
